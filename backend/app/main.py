...
app.add_middleware(
    ...
    allow_origins=os.getenv(
        "ALLOWED_ORIGINS", 
        "http://localhost:3003,http://localhost:3306,https://latinos.paulovila.org,https://api-latinos.paulovila.org,https://back-latinos.paulovila.org,https://api.latinos.paulovila.org"
    ).split(","),
